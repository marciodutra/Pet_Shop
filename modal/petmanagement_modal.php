         ...
         <div class="modal fade" id="smallmodal" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-md" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="smallmodalLabel">Add Management
                                </h5>
                           ...
                           <div class="row">
                            <div class="col-12">
                              <div class="form-group">
                                  ...
                                  <textarea class="form-control" alt="description" id="description" rows="3" placeholder="Enter ..."  autocomplete="off"></textarea>
                                </div>
                              </div>
                                <div class="col-6">
                                <div class="form-group">
                             ...
                             <?php endforeach ?>
                              ...
                              <div class="col-12">
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" row="5" id="Status" alt="status" placeholder="Enter Status Name.." autocomplete="off">
                                </div>
                              </div>
                               <div class="col-12">
                              <div class="form-group">
                            ...
                            <div class="modal-footer">
                               ...
                               <button type="button" class="btn btn-primary" id="add-petmngment"><i class="fa fa-check"></i> Submit</button>
                            </div>
                          </form>
                        </div>
                    </div>
            ...
            <script>
                document.addEventListener('DOMContentLoaded', () => {
                    let btn = document.querySelector('#add-petmngment');
                    btn.addEventListener('click', () => {
                     ...
                     data.append('images', $('#images')[0].files[0]);
                      if (description == '') {
                            ...
                            $.ajax({
                                url: 'controllers/add_petmanagement.php',
                                type: "POST",
                                data: data,
                                processData: false,
                                contentType: false,
