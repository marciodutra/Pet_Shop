                         ...
                         <div class="row">
                          ...
                          <div class="col-4">
                                 <div class="form-group">
                                     ...
                                     <input type="text" class="form-control" alt="customer_name2" id="edit_customername"  placeholder="Customer Name" readonly="">
                                 </div>
                             </div>
                             <div class="col-4">
                                 <div class="form-group">
  ...
  <script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        btn.addEventListener('click', () => {
            ...
            const customer_name = document.querySelector('input[alt=customer_name2]').value;
          ...
          data.append('order_id', order_id);
                ...
                $.ajax({
                    url: 'controllers/edit_order2.php',
                    type: "POST",
                    data: data,
                    processData: false,
                    contentType: false,
