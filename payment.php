                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Tabela de Pagamento</strong>
                                <form method="POST" action="print_table/export_payment.php" style="margin-top: 1%">
                                  <button id="control_export" class="btn btn-info btn-sm pull-right" name="export"><span class="glyphicon glyphicon-print;"></span> Exportar Excel</button>
                                  </form>
                                <button type="button" id="control_add" class="btn btn-success btn-sm" data-toggle="modal" data-target="#smallmodal5" style="margin-left:85%"><i class="fa fa-plus">Adicionar</i>
                               </button>
                            </div>
                            <div class="card-body">
