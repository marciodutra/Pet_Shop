            ...
            <?php
               ...
               <?php } ?> 
                ...
                <div class="more-info pt-2" style="margin-bottom:-10px;">
                    <a class="font-weight-bold font-xs btn-block text-muted small" href="#">Veja mais <i class="fa fa-angle-right float-right font-lg"></i></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            ...
            <?php
                ...
                <div class="clearfix">
                    ...
                    <div class="text-muted text-uppercase font-weight-bold font-xs small">Total produtos</div>
                </div>
                <?php } ?> 
                <div class="b-b-1 pt-3"></div>
                <hr>
            ...
            <div class="card-body">
             <?php
                ...
                <div class="clearfix">
                    ...
                    <div class="text-muted text-uppercase font-weight-bold font-xs small">Total Vendas</div>
                </div>
                 <?php } ?> 
                <div class="b-b-1 pt-3"></div>
                <hr>
            ...
            <div class="card-body">
             ...
             <?php endforeach ?>  
                ...
                <div class="clearfix">
                    ...
                    <div class="text-muted text-uppercase font-weight-bold font-xs small">Renda total</div>
                </div>
                <div class="b-b-1 pt-3"></div>
                <hr>
                <div class="more-info pt-2" style="margin-bottom:-10px;">
