                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Tabela de Pedidos</strong>
                                  <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#smallmodal_o<?php echo $user_session;?>" style="margin-left:77%"><i class="fa fa-plus">Adicionar</i>
                               </button>
                             </a>
                            </div>
                            <div class="card-body">
