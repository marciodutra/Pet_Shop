    ...
    include_once('../config/class/petshop_class.php');
      ...
      $Petshop = new Petshop_class();
        if(ISSET($_POST)){
               ...
               $Petshop->edit_vendor($company_name, $contact_person, $email, $contact_number, $website, $about_company, $username, $password, $vendor_id);
                  echo '<script type="text/javascript">';
                  echo 'setTimeout(function () { swal("Edit Vendor Successfully!","Message!","success");';
                  echo '}, 1000);</script>';
                  echo '<script type="text/javascript">';
