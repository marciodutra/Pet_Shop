                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Gerenciamento de pedidos</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Tabela de gerenciamento de pedidos</strong>
                                    <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#smallmodal_o2<?php echo $user_session;?>" style="margin-left:77%"><i class="fa fa-plus">Adicionar</i>
                               </button>
