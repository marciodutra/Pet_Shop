        ...
        <div class="card">
            ...
            <?php
                ...
                <div class="clearfix">
                    ...
                    <div class="text-muted text-uppercase font-weight-bold font-xs small">Total de produtos</div>
                </div>
                <?php } ?> 
                <div class="b-b-1 pt-3"></div>
                <hr>
            ...
            <div class="card-body">
             <?php
                ...
                <div class="clearfix">
                    ...
                    <div class="text-muted text-uppercase font-weight-bold font-xs small">Total Serviços</div>
                </div>
                 <?php } ?> 
                <div class="b-b-1 pt-3"></div>
                <hr>
