            ...
            <div class="col-sm-5">
                <div class="user-area dropdown float-right">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <strong style="color: #007bff;" class="mt-2">Bem vindo , <?= ucfirst($user_session) ;?></strong> &nbsp;<img class="user-avatar rounded-circle" src="images/admin.jpg" alt="User Avatar">
                    </a>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Tabela de detalhes do pedidoe</strong>
                            ...
                            <div class="default-tab">
                                <nav>
                                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                        <a class="nav-item nav-link active" id="nav-Approved-tab" data-toggle="tab" href="#nav-Approved" role="tab" aria-controls="nav-Approved" aria-selected="true">Aprovada</a>
                                        <a class="nav-item nav-link" id="nav-Deliver-tab" data-toggle="tab" href="#nav-Deliver" role="tab" aria-controls="nav-Deliver" aria-selected="false">Para entrega</a>
                                        <a class="nav-item nav-link" id="nav-Received-tab" data-toggle="tab" href="#nav-Received" role="tab" aria-controls="nav-Received" aria-selected="false">Recebida</a>
                                        <a class="nav-item nav-link" id="nav-Cancelled-tab" data-toggle="tab" href="#nav-Cancelled" role="tab" aria-controls="nav-Cancelled" aria-selected="false">Cancelada</a>
                                    </div>
                                </nav>
