...
<body style="background-color: #a3a048">
        ...
        <div class="container">
            <div class="login-content">
                ...
                <div class="login-form">
                    <div class="">
                        <h3 style="background-color: #ffff;font-weight: bold;"><img src="../images/1627478.png" height="30px" width="30px">&nbsp;&nbsp; Login do fornecedor</h3>
                        <hr>
                        </hr>
                    </div>
                    <form role="form" id="logform">
                        ...
                        <button type="button" id="vendor-login" class="btn btn-primary btn-flat m-b-30 m-t-30"><span id="logtext">Entrar</span></button><br><br>
                        <div>
